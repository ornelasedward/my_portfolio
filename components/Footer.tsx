    ...
    <footer className="border-t-2 border-black mt-20">
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="flex justify-center space-x-6">
          {footers.map((footer) => (
            <a href={footer.url} key={footer.name}>
              <h1 className=" md:text-3xl font-light border-transparent border-2 hover:border-black p-4 rounded-xl">
                {footer.name}
              </h1>
            </a>
          ))}
        ...
        <div className="mt-8 flex gap-4 justify-center">
          ...
          <a href="/admin">
            <p className="text-xs leading-5 text-gray-400">administrative</p>
          </a>
        </div>
